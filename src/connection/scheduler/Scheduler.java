...
public class Scheduler extends AbstractScheduler {
	...
	public static Scheduler getInstance(ConnectionInterface connection){
		if(instance==null)
			instance=new Scheduler(connection);
		return instance;
	}
	private Scheduler(ConnectionInterface connection){
		super(connection);
	}
